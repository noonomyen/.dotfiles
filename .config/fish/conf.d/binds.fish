...
if status is-interactive
    function fish_user_key_bindings
        ...
        if functions -q _natural_selection
            ...
            # Select all
            bind ctrl-a            '_natural_selection beginning-of-line' '_natural_selection end-of-line --is-selecting'
            ...
            # Alt + Shift + Arrow Keys (Select Word)
            ...
            # Ctrl + Arrow Keys & Alt + Arrow Keys (Normal Word Movement)
